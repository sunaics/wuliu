  ...
  <div class="waybill">
    ...
    <div class="list">
      <div class="item" v-for="item in list" :key="item.id">
        <div class="labels">
          <div class="label1" v-if="item.status == 1">待运输</div>
          <div class="label2" v-if="item.status == 2">运输中</div>
          <div class="label3" v-if="item.status == 3">已完成</div>
        </div>
...
.waybill {
  ...
  .top_box {
    width: 100%;
    height: 252rpx;
    background: linear-gradient(135deg, #64a7fe 0%, #4e5ff7 100%);
    border-radius: 16rpx;
    color: #fff;
